...
def main():
    ...
    from export_biaoqiao import _get_report_month
    ...
    report_month = _get_report_month(None, None)
    ...
    step_funcs = {
        ...
        "export_ejy_tongqi": lambda d: export_ejy_tongqi(d, output_dir),
        "click_qysch_sidebar": click_qysch_sidebar,
        "export_all_qysch_data": lambda d: export_all_qysch_data(d, output_dir),
        "export_all_biaoxun_data": lambda d: export_all_biaoxun_data(d, output_dir),
    }
